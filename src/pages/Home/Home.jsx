		...
		<main className="min-h-screen w-full poppins-regular  bg-background">
			...
			<nav className="w-full flex items-center justify-between bg-background text-text px-8 py-2 shadow-md">
				...
				<a
					...
					className="p-2 px-6 border border-gray-600 rounded-md text-textSecondary hover:bg-gray-100 transition duration-300"
				>
					GitHub
				</a>
			</nav>
				...
				<div className="w-full md:w-1/2 mb-8 md:mb-0 md:mr-8">
					<div className="text-text poppins-semibold flex flex-col items-center md:items-start justify-between gap-3  md:gap-0">
						...
						<div className="flex items-center">
							<h1 className="font-bold text-2xl sm:text-3xl md:text-4xl leading-tight md:leading-relaxed mr-2">
			...
			<section className="bg-background py-16 px-10">
				<div className="max-w-4xl mx-auto text-center">
					<h2 className="text-3xl md:text-4xl font-bold text-text mb-10">Why Choose Calculator Hub?</h2>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						{/* Reason 1 */}
						<div className="bg-background shadow-primary p-8 rounded-lg shadow-md">
							<h3 className="text-xl font-bold text-text mb-4">User-Friendly Interface</h3>
						...
						{/* Reason 2 */}
						<div className="bg-background shadow-primary p-8 rounded-lg shadow-md">
							<h3 className="text-xl font-bold text-text mb-4">Accurate Calculations</h3>
							<p className="text-gray-600">
						...
						{/* Reason 3 */}
						<div className="bg-background shadow-primary p-8 rounded-lg shadow-md">
							<h3 className="text-xl font-bold text-text mb-4">Wide Range of Tools</h3>
							<p className="text-gray-600">
						...
						{/* Reason 4 */}
						<div className="bg-background shadow-primary p-8 rounded-lg shadow-md">
							<h3 className="text-xl font-bold text-text mb-4">Responsive Support</h3>
			...
			{/* footer */}
			<footer className="py-6 bg-background  text-text mt-10 shadow-md">
